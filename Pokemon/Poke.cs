...
//    using Pokemon;
//
//    var poke = Poke.FromJson(jsonString);
...
namespace Pokemon
{
    ...
    public partial class Poke
    {
        public static Poke FromJson(string json) => JsonConvert.DeserializeObject<Poke>(json, Pokemon.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Poke self) => JsonConvert.SerializeObject(self, Pokemon.Converter.Settings);
    }
